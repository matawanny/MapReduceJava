...
fnma_loan_monthly(){
local output_file=fnma_loan_monthly.dat
...
from prd1.fnma_loan_daily where as_of_date=$asOfDateMonthly " -o $output_file --print_header --output_delimiter=\|
...
local output_file=fnma_arm_loan_monthly.dat
...
local output_file=fnma_mod_loan_monthly.dat
