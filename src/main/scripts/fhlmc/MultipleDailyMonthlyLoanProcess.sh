...
do
        ...
        then
          ...
          then
	          ...
	          sh $APP/yb-apache-hbase/src/main/scripts/fhlmc/Impala_fhlmc_daily_export.sh $as_of_date $daily_return_code
	      fi
          ...
          then
          	...
          	sh $APP/yb-apache-hbase/src/main/scripts/fhlmc/MonthlyInitializeProcess.sh $as_of_date
          	echo "sh $APP/yb-apache-hbase/src/main/scripts/fhlmc/MonthlyLoanProcess.sh $as_of_date"
          	sh $APP/yb-apache-hbase/src/main/scripts/fhlmc/MonthlyLoanProcess.sh $as_of_date
          	monthly_return_code=$?
