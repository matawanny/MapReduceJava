...
fhlmc_loan_daily(){
local output_file=fhlmc_loan_daily.dat
...
fhlmc_arm_loan_daily(){
local output_file=fhlmc_arm_loan_daily.dat
...
fhlmc_mod_loan_daily(){
local output_file=fhlmc_mod_loan_daily.dat
